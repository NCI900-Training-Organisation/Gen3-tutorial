...
Other services use ``Arborist`` for authorization decisions, including API-level
access and permission to read or delete a specific indexed record. Services
should offload all authorization-related logic to ``Arborist`` as much as possible.
